...
@section('title', 'Android Mail APP')
                                    ...
                                    <div class="wpb_single_image wpb_content_element  vc_align_left">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="vc_single_image-wrapper  ">
                                                <img width="324" height="576" src="{{asset(('images/signature_mail_introduction/android_mail_app_img1.png'))}}" class="img-responsive" alt="Mail App Android Email Signature">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element  vc_align_left">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="vc_single_image-wrapper  ">                                               
                                                <img width="324" height="576" src="{{asset(('images/signature_mail_introduction/android_mail_app_img2.png'))}}" class="img-responsive" alt="Mail App Android Email Signature" >
                                            </div>
                                ...
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element  vc_align_left">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="vc_single_image-wrapper  ">
                                               <img width="324" height="576" src="{{asset(('images/signature_mail_introduction/android_mail_app_img3.png'))}}" class="img-responsive" alt="Mail App Android Email Signature">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 wpb_column column_container section-highlight">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element  vc_align_left">
                                        <div class="wpb_wrapper">
                                            <div class="vc_single_image-wrapper  ">
                                               <img width="324" height="576" src="{{asset(('images/signature_mail_introduction/android_mail_app_img4.png'))}}" class="img-responsive" alt="Mail App Android Email Signature">
                                        </div>
                                    </div>
                                </div>
                            </div>
