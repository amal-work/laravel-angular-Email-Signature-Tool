                        ...
                        <div class="row signature-text-font">     
                            ...
                            <div class="col-sm-12 wpb_column column_container section-highlight">
                                <div class="wpb_wrapper">
                                    ...
                                    <div class="wpb_single_image wpb_content_element  vc_align_left">
                                        <div class="wpb_wrapper">                                                                                       
                                            <img width="710" height="485" src="{{asset(('images/signature_mail_introduction/Outlook-2013-3.png'))}}" class="img-responsive" alt="Outlook 2013 3">
                                        </div>
                                    </div>
                                </div>
                            </div>
